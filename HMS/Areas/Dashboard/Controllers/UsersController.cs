...
namespace HMS.Areas.Dashboard.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<JsonResult> Action(UserActionModel model)
        {
            ...
            if (!string.IsNullOrEmpty(model.ID)) // we are tyring to edit model
            {
            ...
            else // we are trying to create the record
            {
        ...
        public async Task<JsonResult> Delete(UserActionModel model)
        {
            ...
            if (!string.IsNullOrEmpty(model.ID)) // we are tyring to delete a record
            {
                var user = await UserManager.FindByIdAsync(model.ID);
